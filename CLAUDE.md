...
repository: layout, the TypeScript-canonical / Go-and-Rust-port
contract, how the plugin works, build & test commands, the shared spec
fixtures and the intentional TS/Go/Rust differences, and how to treat
untrusted input.
